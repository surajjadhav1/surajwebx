(function () {
    ...
    function _loadJs(a) {
        ...
        a instanceof y && a.constructor === y
            ? (a = a.g)
            : ((b = typeof a), u("expected object of type TrustedResourceUrl, got '" + a + "' of type " + ("object" != b ? b : a ? (Array.isArray(a) ? "array" : b) : "null")), (a = "type_error:TrustedResourceUrl"));
        d.src = a;
        var f;
        a = ((d.ownerDocument && d.ownerDocument.defaultView) || window).document;
        (f = (b = null === (f = a.querySelector) || void 0 === f ? void 0 : f.call(a, "script[nonce]")) ? b.nonce || b.getAttribute("nonce") || "" : "") && d.setAttribute("nonce", f);
        A(d);
    }
    function _loadCss(a) {
